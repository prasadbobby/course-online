        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground">
              A leading online learning platform for students and professionals. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/partnership" className="text-muted-foreground hover:text-primary transition-colors">
                  Partnership
                </Link>
              </li>
              <li>
